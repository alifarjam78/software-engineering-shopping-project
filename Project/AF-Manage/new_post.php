    ...
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <?php 
				...
				{
					$id = $_POST["id"];
					$q = $cn->pdo->query("select * from post where id ='".$id."'");
					$q->execute();
					if($q->rowCount() == 1)
					{
            ...
            <div class="content">
                ...
                <div class="page-header">
					<div class="wrap-title">
						...
						<h1>افزودن پست <small>مطلب جدید</small></h1>
					</div>
					<ul class="breadcrumb">
						<li class="active">افزودن مطلب</li>
					</ul>
					<div class="clear"></div>
                </div>  
            </div>
            	<form onSubmit="" action="action/add_post.php" method="post" enctype="multipart/form-data">
				<?php 
					...
					<div class="row-form">
						...
						<div class="span9">
							<select name="category">
								...
								<?php
									$q = $cn->pdo->query("select * from category where part = 2");
									$q->execute();
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab1">
								...
								<div class="row-form">
									...
									<div class="span9">
										<input type="text" name="title" id="title"  value="<?php echo @$post["title"]; echo @$_SESSION["title"];unset($_SESSION["title"]); ?>">
									</div>
								</div>
								...
								<div class="row-form">
									...
									<div class="span9">
										<textarea name="text" id="text"><?php echo @$post["text"]; echo @$_SESSION["text"];unset($_SESSION["text"]); ?></textarea>
									</div>
								</div>
								<div class="row-form">
									<div class="span3 pull-right">متن کامل * :</div>
									<div class="span9">
										<textarea name="more_text" id="more_text"><?php echo @$post["more_text"]; echo @$_SESSION["mor_text"];unset($_SESSION["mor_text"]); ?></textarea>
									</div>
								</div>
								...
								<div class="row-form">
									...
									<div class="span9">
										<input type="text"  name="autor" id="autor" value="<?php echo @$post["autor"]; echo @$_SESSION["autor"];unset($_SESSION["autor"]); ?>">
									</div>
								</div>
								...
								<div class="row-form">
									...
									<div class="span9">
										<input type="text"  name="keyword" id="keyword" value="<?php echo @$post["keyword"]; echo @$_SESSION["keyword"];unset($_SESSION["keyword"]); ?>">
									</div>
								</div>	
							...
							<div class="tab-pane" id="tab2">
								<div class="row-form">
									...
									<div class="span9">
										<input type="text" name="title_en" id="title_en"  value="<?php echo @$post["title_en"]; echo @$_SESSION["title_en"];unset($_SESSION["title_en"]); ?>">
									</div>
								</div>
								...
								<div class="row-form">
									...
									<div class="span9">
										<textarea name="text_en" id="text_en"><?php echo @$post["text_en"]; echo @$_SESSION["text_en"];unset($_SESSION["text_en"]); ?></textarea>
									</div>
								</div>
								<div class="row-form">
									<div class="span3 pull-right">Complete Text * :</div>
									<div class="span9">
										<textarea name="more_text_en" id="more_text_en"><?php echo @$post["more_text_en"]; echo @$_SESSION["more_text_en"];unset($_SESSION["more_text_en"]); ?></textarea>
									</div>
								</div>
								...
								<div class="row-form">
									...
									<div class="span9">
										<input type="text" name="keyword_en" id="keyword_en"  value="<?php echo @$post["keyword_en"]; echo @$_SESSION["keyword_en"];unset($_SESSION["keyword_en"]); ?>">
									</div>
								</div>
							</div>
